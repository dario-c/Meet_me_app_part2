...
RSpec.describe Location, :type => :model do
	...
	it "Count_visits method returns number of total visit in that month and year" do
		...
		Visit.create location_id: location1.id, user_id: "Jane", from_date: Date.today, to_date: Date.today+3
		Visit.create location_id: location1.id, user_id: "Edu", from_date: Date.today+10, to_date: Date.today+23
